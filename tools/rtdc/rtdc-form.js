...
function submitRtDc()
{
  ...
  document.getElementById("rt-label").innerHTML = "Rt: ";
  document.getElementById("dc-label").innerHTML = "Dc: ";
  ...
  // calculate Rt
  var rt = getRt();
  document.getElementById("rt-label").innerHTML = "Rt: " + rt;
  // calculate dc
  var dc = getDc();
  document.getElementById("dc-label").innerHTML = "Dc: " + dc;
...
function checkPeriodBreak()
{
  ...
  if (parseInt(min_sLast)-15 <= parseInt(min_eFirst))
  {
    ...
    alert("The break between periods is less than 15 minutes.\n \
